...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference("Genre.count") do
      post genres_url, params: { genre: { g_genreid: @genre.g_genreid, g_genrename: @genre.g_genrename } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { g_genreid: @genre.g_genreid, g_genrename: @genre.g_genrename } }
