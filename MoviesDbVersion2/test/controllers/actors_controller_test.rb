...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { a_actorid: @actor.a_actorid, a_actorname: @actor.a_actorname } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { a_actorid: @actor.a_actorid, a_actorname: @actor.a_actorname } }
